...
namespace DotNumerics.LinearAlgebra
{
    ...
    public abstract class BaseMatrix: IMatrix<double>
    {
        ...
        /// <summary>
        /// Matrix-scalar subtraction, C=A-b
        /// </summary>
        ...
        /// <summary>
        /// Matrix-scalar subtraction, C=b-A
        /// </summary>
        /// <param name="B">The Scalar</param>
        /// <returns>C=B-A</returns>
        public Matrix SubtractFrom(double B)
        {
            Matrix C = new Matrix(this._RowCount, this._ColumnCount);
		...
		/// <summary>
		/// RMS of elements = RMSij(A[i,j])
		/// </summary>
		/// <returns>The root mean square of elements.</returns>
		public double ElementsRMS() {
			double TemSum = 0.0;
			for (int i = 0; i < this._Data.Length; i++) {
				TemSum += this._Data[i] * this._Data[i];
			}
			return Math.Sqrt(TemSum);
		}
        /// <summary>
        /// Transposed matrix.
        /// </summary>
        ...
        /// </summary>
        /// <param name="A"> The left side double of the subtraction operator.</param>
        /// <param name="B">The right side matrix of the subtraction operator.</param>
        /// <returns>A matrix that represents the result of the matrix subtraction.</returns>
        ...
        /// </summary>
        /// <param name="A"> The left side matrix of the subtraction operator.</param>
        /// <param name="B">The right side double of the subtraction operator.</param>
        /// <returns>A matrix that represents the result of the matrix subtraction.</returns>
        public static Matrix operator -(BaseMatrix A, double B)
        {
